...
function About() {
    ...
    return (
        <div className='container my-4' style={darkmode}>
            ...
            {
                !dark ?
                    <button type="button" onClick={e => setdark(true)} className="btn btn-dark my-3">Dark</button>
                    : <button type="button" onClick={e => setdark(false)} className="btn btn-light my-3">Light</button>
            }
        </div>
    )
}
